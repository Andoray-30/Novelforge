...
class ContentMetadata(BaseModel):
    ...
    parent_id: Optional[str] = Field(default=None, description="父内容 ID")
    children_ids: List[str] = Field(default_factory=list, description="子内容 ID 列表")
    session_id: Optional[str] = Field(default=None, description="绑定的会话或项目 ID")
...
class ContentCreateRequest(BaseModel):
    ...
    metadata: ContentWriteMetadata = Field(..., description="内容元数据")
...
class ContentSearchRequest(BaseModel):
    ...
    session_id: Optional[str] = Field(default=None, description="所属会话 ID 过滤")
    parent_id: Optional[str] = Field(default=None, description="父内容 ID 过滤，用于按小说根节点筛选资产")
...
class ContentExportRequest(BaseModel):
    ...
    content_ids: List[str] = Field(..., description="要导出的内容 ID 列表")
